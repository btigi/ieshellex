...
namespace IEBAMPreview
{
    ...
    [DisplayName("BAM Preview Handler")]
    [Guid("7a8317ac-eb82-4413-912c-e3b26ecfa1c7")]
    [PreviewHandler(DisableLowILProcessIsolation = false)]
    public class BamPreviewHandler : SharpPreviewHandler
    {
        /// <summary>
        ...
        protected override PreviewHandlerControl DoPreview()
        {
            ...
            var handler = new BamPreviewHandlerControl();
